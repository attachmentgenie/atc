...
func (f *Incident) starting(ctx context.Context) error {
	return nil
}

func (f *Incident) stopping(_ error) error {
	return nil
}

func New(logger log.Logger) (*Incident, error) {
...
func (f *Incident) watcher(ctx context.Context) error {

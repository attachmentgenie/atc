...
func (f *Deployer) starting(ctx context.Context) error {
	return nil
}

func (f *Deployer) stopping(_ error) error {
	return nil
}

func New(logger log.Logger) (*Deployer, error) {
...
func (f *Deployer) watcher(ctx context.Context) error {

...
func (f *Forwarder) starting(ctx context.Context) error {
	return nil
}

func (f *Forwarder) stopping(_ error) error {
	return nil
}

func New(logger log.Logger) (*Forwarder, error) {
...
func (f *Forwarder) watcher(ctx context.Context) error {
